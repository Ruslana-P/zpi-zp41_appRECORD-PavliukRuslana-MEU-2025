export const getLab3_8_description = () => (
  <>
    <h4>Тема лабораторної роботи 3.2:</h4>
    <p style={{ textAlign: "justify" }}>
      ОБʼЄКТ. МЕТОДИ ОБʼЄКТА. МАСИВ ОБʼЄКТІВ. ДЕСТРУКТУРИЗАЦІЯ ОБʼЄКТІВ.
      CALLBACK. СТРІЛОЧНІ ФУНКЦІЇ. СТРІЛОЧНІ ФУНКЦІЇ ЯК КОЛБЕКИ​.
    </p>
    <h4>Мета:</h4>
    <p style={{ textAlign: "justify" }}>
      Придбати практичні навички роботи з обʼєктами. Методи обʼєкта. Callback.
